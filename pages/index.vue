<template>
  <div>
    ...
    <div class="grey darken-3" id="about">
      <v-row class="about">
        <v-col
          class="white block-left d-flex flex-column align-center pr-16"
          cols="12"
          lg="6"
        >
        ...
        <v-col
          class="grey darken-4 block-right d-flex flex-column align-center"
          cols="12"
          lg="6"
          id="secure"
        >
    ...
    <div class="prices" id="price">
      ...
      <div class="prices__body container">
        ...
        <v-form ref="form" v-model="valid" lazy-validation>
          <v-row style="max-width: 800px" justify="center" class="mb-9 mx-auto">
        ...
        <div class="d-flex justify-center">
          <v-btn outlined rounded color="amber" @click="sendRequest">{{
            $t("contact.btn")
          }}</v-btn>
        </div>
      </div>
    ...
    <div class="partners">
      <div class="partners__title text-center text-uppercase">
        {{ $t("partners.title") }}
      </div>
      <div class="partners__subtitle text-center text-uppercase">
        {{ $t("partners.subtitle") }}
      </div>
...
export default {
  ...
  methods: {
    sendRequest() {
      ...
      if (valid) {
        this.$axios
          .$post("/api/v1/request", this.request, config)
          .then((req) => {
            if (req) {
